...
class LogsTab:
    ...
    def test_server_connection(self):
        ...
        def test_thread():
            ...
            if self.main_window.log_manager.test_connection(url):
    ...
    def send_test_file(self):
        ...
        def send_thread():
            ...
            if self.main_window.log_manager.send_test_file(url, logs_per_file):
    ...
    def start_log_sending(self):
        ...
        if self.main_window.log_manager.start_log_sending(config, self.update_progress):
    ...
    def stop_log_sending(self):
        ...
        self.main_window.log_manager.stop_log_sending()
