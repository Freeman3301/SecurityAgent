...
from services.log_collector import LogCollector  # Изменен импорт
...
class MainWindow:
    ...
    def __init__(self, root, logic):
        ...
        # Менеджер логов (теперь один класс)
        self.log_collector = LogCollector(self.log_send)  # Изменено название
